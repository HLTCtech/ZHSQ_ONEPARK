...
// You can change the port by the following method: port = 9527 npm run dev OR npm run dev --port = 9527
...
module.exports = {
  ...
  devServer: {
    ...
    proxy: {
      ...
      // }
      [process.env.VUE_APP_BASE_API]: {
        // target: 'http://192.168.31.86:8080/hlOneParkProertyManage',
        // target: "http://192.168.1.42:8080/hlOneParkProertyManage",
        // target: "http://192.168.31.137:8080/hlOneParkProertyManage",
    ...
    // 测试去掉mock after: require('./mock/mock-server.js')
  },
  configureWebpack: {

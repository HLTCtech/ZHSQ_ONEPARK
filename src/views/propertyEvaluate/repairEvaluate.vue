<template>
  ...
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" highlight-current-row stripe border fit :data="tableData" style="width: 100%" height="800">
      ...
      <el-table-column label="响应速度" prop="responseRate" align="center" fixed />
      <el-table-column label="报修质量" prop="repairRate" align="center" fixed />
...
export default {
  ...
  methods: {
    ...
    // 点击意见建议获取详情
    getSuggestAll(id) {
      getRepairSuggestDetail(id).then(response => {

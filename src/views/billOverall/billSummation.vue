  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['费用\周期', '本周个数', '本周', '本周代金券', '本月个数', '本月', '本月代金券', '本年个数', '本年', '本年代金券']
        const filterVal = ['billItem', 'weeklyNums', 'billByWeek', 'voucherByWeek', 'monthlyNums', 'billByMonth', 'voucherByMonth', 'yearlyNums', 'billByYear', 'voucherByYear']

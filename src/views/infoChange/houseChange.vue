<template>
  ...
  <div class="app-container">
    ...
    <el-table :data="tableData" style="width: 100%" height="800" highlight-current-row>
      ...
      <el-table-column label="变更信息" align="center" style="width:120px" class-name="small-padding fixed-width" fixed="right">
        <template slot-scope="{ row }">
          <el-button type="primary" style="width:100px" size="mini" @click="handleHouseInfoArea(row)">
            变更面积
          </el-button>
        </template>
      </el-table-column>
      <el-table-column label="变更信息" align="center" style="width:120px" class-name="small-padding fixed-width" fixed="right">
        <template slot-scope="{ row }">
          <el-button type="primary" style="width:100px" size="mini" @click="handleHouseInfoUser(row)">
            变更业主
          </el-button>
        </template>
      </el-table-column>
    ...
    <!-- 房源信息变更模态框 -->
    <el-dialog :visible.sync="dialogHouseInfoVisibleArea" title="房源信息变更">
...
import { fetchHouseInfoAll, fetchHouseInfoSearch, postHouseInfoArea, postHouseInfoUser, fetchHouseInfoByHouseId, postNewHouseInfo } from '@/api/infoChange'

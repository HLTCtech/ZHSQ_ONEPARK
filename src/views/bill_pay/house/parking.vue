<template>
  ...
  <div class="app-container">
      ...
      >
        <template slot-scope="{ row }">
          ...
          <el-button
            type="primary"
            size="mini"
            @click="handleRangeStart(row.carLoc)"
          >
            指定日期
          </el-button>
        </template>
    ...
    <!-- 指定停车场维护费周期开始日期 -->
    <el-dialog
      :visible.sync="dialogRangeStart"
      title="指定停车场维护费周期开始日期"
      width="40%"
    >
      ...
      <el-button
        ...
        @click="daterangeStartPost(dateRangeStartForm)"
        >提交</el-button
      >
    ...
    <!-- 信息变更按钮：定义表单提交项 -->
    <el-dialog
      :visible.sync="dialogParkingInfoChangeFormVisible"
      title="信息变更/续费"
    >
      <!-- 展示当前房间的费用状态统计 -->
      <el-table
      ...
      <el-card class="box-card">
        ...
        >
          ...
          >
            <el-input
              v-model.number="infoChangeFormPost.moneyNum"
              width="100px"
            />
          </el-form-item>
          <el-form-item label="代金券金额" label-width="100px" prop="voucher">
            <el-input
              v-model="infoChangeFormPost.voucher"
          ...
          <el-form-item>
            <el-button
              type="success"
              @click="handleSubmitInfoChangeForm(infoChangeFormPost)"
              >提交</el-button
            >
    ...
    >
      ...
      <el-button
        type="success"
        @click="handleChangeInfoPost(infoChangeFormPost)"
        >确定提交</el-button
      >
    ...
    <el-dialog :visible.sync="dialogNewCarInfoVisible" title="新增车辆信息">
      ...
      <el-card class="box-card">
        ...
        >
          ...
          <el-form-item label="代金券金额" label-width="100px" prop="voucher">
            <el-input
              v-model="newInfoFormPost.voucher"
              placeholder="请输入代金券金额"
            />
          </el-form-item>
          <el-form-item label="实收总金额" label-width="100px">
    ...
    >
      ...
      <br />
      <br />
      <el-button type="success" @click="handleNewInfoPost(newInfoFormPost)"
        >确定提交</el-button
      >
...
export default {
  ...
  methods: {
    ...
    handleChangeInfoPost(infoChangeFormPost) {
      if (
        infoChangeFormPost.smsCode === null ||
        infoChangeFormPost.smsCode.length < 6
      ) {
    ...
    handleNewInfoPost(newInfoFormPost) {
      if (
        newInfoFormPost.smsCode === null ||
        newInfoFormPost.smsCode.length < 6
      ) {
        this.$message({ message: '请输入正确的验证码', type: 'error' })
      } else {
        postNewCarInfo(newInfoFormPost).then(response => {

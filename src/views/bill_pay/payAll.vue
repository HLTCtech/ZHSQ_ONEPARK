        ...
        <div label="复合缴费" label-width="100px">
          ...
          >
            ...
            <el-form-item>
              <el-button
                type="success"
                @click="mixSubmitFormPost(mixFormPost)"
              >提交</el-button>
        ...
        <div label="复合缴费" label-width="100px">
          ...
          >
            ...
            <el-form-item>
              <el-button
                type="success"
                @click="allItemsFormPost(ItemsPay)"
              >提交</el-button>
              <el-button @click="CleanDataForm()">取消</el-button>
            </el-form-item>
          </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      couponText: '点击使用代金券',
      useCoupon: false, // 物业费是否使用代金券
      searchCouponText: '',
      couponData: [] // 查询出的优惠券信息
    }
  },
  computed: {
